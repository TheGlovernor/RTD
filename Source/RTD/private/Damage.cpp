...
void UDamage::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
...
void UDamage::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
...
void UDamage::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
